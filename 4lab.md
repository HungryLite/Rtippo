...
![Диаграмма](https://github.com/HungryLite/Rtippo/blob/main/images/lab4(1).drawio.png)
...
| Постусловия | Полученно сообщение «Ошибка ввода данных для Игроков»|
***

### Прецедент «Раздать карты»

![Диаграмма](https://github.com/HungryLite/Rtippo/blob/main/images/lab4(2.0).drawio.png)
...
![Диаграмма](https://github.com/HungryLite/Rtippo/blob/main/images/lab4(3.0).drawio.png)
...
| Действие    | MessageBox.Show("Вы выиграли", Information) |
|:------------|:-|
| Ссылки      | Преценденты: «Принять решение о ставке» |
| Предусловия | Ставка выиграла |
| Постусловия | Полученно сообщение |

| Действие    | MessageBox.Show("Ставка не выиграла", Error) |
|:------------|:-|
| Ссылки      | Преценденты: «Принять решение о ставке» |
...
![Диаграмма](https://github.com/HungryLite/Rtippo/blob/main/images/lab4(4.0).drawio.png)

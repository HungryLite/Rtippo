...
|                            | 3. Предоставить Игроку выбор сделать ставку.             |
|                            | 4. Предоставить Игроку ввести размер ставки.             |
|                            | 5. Система ожидает решение Игрока.                       |
| 6. Ввести размер ставки.   |                                                          |
| 7. Нажать на кнопку «Поставить».|                                                     |
|                            | 8. Запомнить размер ставки.                              |
|                            | 9. Выдать Игроку карту.                                  |
|                            | 10. Сохранить размер ставки и выдать такую же сумму из «пул»-банка Игроку.|
|                            | 11. Сообщить Игроку о выигрыше                           |
|                            | 12. Переместить следующий ход влево.                     |

### Альтернативный сценарий

__5а. Если Игрок не будет делать ставку:__  
- Игрок нажимает на кнопку «Отказаться».  
- Пункты 6, 7, 8, 9, 10, 11 не выполняются.

__7а. Если размер ставки не соответсвует допустимым пределам:__  
...
__9а. Если добранная карта Игрока не имеет промежуточное достоинство между двумя его первыми картами:__  
- Ставка Игрока уходит в «пул»-банк.
- Сообщить Игроку о проигрыше.  
- Пункты 10, 11 не выполняются.
***
